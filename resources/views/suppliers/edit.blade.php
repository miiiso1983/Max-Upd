...
@section('title', 'تعديل المورد - MaxCon ERP')
...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600">تعديل بيانات المورد: {{ $supplier->name }}</p>
        </div>
        <div class="flex space-x-2 space-x-reverse">
            <a href="{{ route('suppliers.show', $supplier) }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg">
    ...
    <form action="{{ route('suppliers.update', $supplier) }}" method="POST" class="space-y-6">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name_ar" id="name_ar" value="{{ old('name_ar', $supplier->name_ar) }}"
                    ...
                    <div>
                        ...
                        <select name="type" id="type" required
                            ...
                            <option value="importer" {{ old('type', $supplier->type) == 'importer' ? 'selected' : '' }}>مستورد</option>
                            <option value="local_supplier" {{ old('type', $supplier->type) == 'local_supplier' ? 'selected' : '' }}>مورد محلي</option>
                        </select>
                        @error('type')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="tel" name="mobile" id="mobile" value="{{ old('mobile', $supplier->mobile) }}"
                    ...
                    <div>
                        ...
                        <input type="tel" name="fax" id="fax" value="{{ old('fax', $supplier->fax) }}"
                    ...
                    <div>
                        ...
                        <input type="tel" name="contact_phone" id="contact_phone" value="{{ old('contact_phone', $supplier->contact_phone) }}"
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="license_number" id="license_number" value="{{ old('license_number', $supplier->license_number) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="iban" id="iban" value="{{ old('iban', $supplier->iban) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="swift_code" id="swift_code" value="{{ old('swift_code', $supplier->swift_code) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="rating" id="rating"
                            ...
                            <option value="4" {{ old('rating', $supplier->rating) == '4' ? 'selected' : '' }}>4 - جيد جداً</option>
                            <option value="5" {{ old('rating', $supplier->rating) == '5' ? 'selected' : '' }}>5 - ممتاز</option>
                        </select>
                        @error('rating')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select name="status" id="status"
                            ...
                            <option value="blocked" {{ old('status', $supplier->status) == 'blocked' ? 'selected' : '' }}>محظور</option>
                        </select>
                        @error('status')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="md:col-span-2">
                        <label class="flex items-center">
                            <input type="checkbox" name="is_preferred" value="1" {{ old('is_preferred', $supplier->is_preferred) ? 'checked' : '' }}
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="notes" id="notes" rows="4"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 @error('notes') border-red-500 @enderror">{{ old('notes', $supplier->notes) }}</textarea>
                        @error('notes')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
        ...
        <div class="flex justify-end space-x-4 space-x-reverse">
            <a href="{{ route('suppliers.show', $supplier) }}" class="px-6 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400">
                إلغاء
            </a>
